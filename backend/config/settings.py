...
# PostgreSQL (or any other dj-database-url-supported backend) for production.
...
# Production security hardening — only applies when DEBUG is off, so local
...
# Third-party API keys (backend-side; never exposed to the frontend)
